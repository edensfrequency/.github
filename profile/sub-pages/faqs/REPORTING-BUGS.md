...
Open an issue on the specific product's GitHub repo, not this one. Each product tracks its own bugs:

- [Boom Bap Producer Pads issues](https://github.com/edensfrequency/boom-bap-producer-pads/issues)
- [Boom Bap Producer Decks issues](https://github.com/edensfrequency/boom-bap-producer-decks/issues)
- [Boom Bap Producer Key Sampler issues](https://github.com/edensfrequency/boom-bap-producer-key-sampler/issues)
