...
**VST (Virtual Studio Technology)** is a plugin format, originally created by Steinberg, that lets instruments and effects run *inside* a DAW instead of as separate standalone applications. See **[What's a DAW?](WHATS-A-DAW.md)** if you're not sure what that means yet.
